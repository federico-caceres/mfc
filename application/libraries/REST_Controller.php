 ...
 * @version         3.0.0
 */
abstract class REST_Controller extends Salientes_Controller {
    ...
    {
         (is_array($data)) ? $data['status'] = $http_code : '';
         log_message("celiterinfo", "Retorno desde WS: " . json_encode($data));
