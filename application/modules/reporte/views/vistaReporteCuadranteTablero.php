 ...
 */
?>
<table id="tablero_reporteCuadrante" class="table table-striped responsive">
    <thead>
        <tr>
    ...
    <tbody> <?php
        if (isset($ReporteCuadrante) && sizeof($ReporteCuadrante) > 0) {
            foreach ($ReporteCuadrante as $key => $value) {
                ?>
                <tr class="odd gradeX">
