...
class Matrimonio extends Mfcparaguay {
    ...
    public function viewCabeceraMatrimonios() {
        ...
        $datos = array(
            'tablero_matrimonio' => Modules::run('matrimonio/Matrimonio/lista_matrimonio', array('-1', '-1', '-1', '-1', "1")),
    ...
    public function lista_matrimonio($params) {
    ...
    public function eliminaCurso() {
        ...
        $idMatrimonio = $this->input->post('idMatrimonio');
        $idAporte = $this->input->post('idCurso');
    ...
    public function reactivarMatrimonio($idmatrimonio) {
        ...
        $idBase = (($nivel != 3) ? "-1" : $userData->idbase);
        $idMatrimonio = (isset($idmatrimonio)) ? $idmatrimonio : $this->input->post("idmatrimonio");
        $resultado = $this->m_matrimonio->reactivarMatrimonio($idMatrimonio);
        ...
        $data['vista'] = $this->load->view('s07/cabecera_lista', $datos, TRUE);
