...
<div id="contieneFormAporte" class="col-sm-12 well" style="background-color:  #D8D8D8">
    ...
    <div class="col-sm-12">
        <button id="guardarAporte" class="btn btn-primary" onclick="nuevoAporte()">Gurdar Aporte</button>
        <button id="cancelarAporte" class="btn btn-danger" onclick="s06('<?= $idmatrimonio ?>')">Cancelar</button>
    </div>
    <br>
