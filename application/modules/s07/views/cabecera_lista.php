...
<div class="row responsive well" id="contenedorSuperiorReporte">
    <div style="text-align: center">
        <h3>Listado de Matrimonios con S07</h3>
    </div>
    <br>
...
<!--        <div class="col-sm-1"><strong>Desde:</strong></div>-->
    ...
    <!--    <div class="col-sm-1"><strong>Hasta:</strong></div>
        ...
        <div class="col-sm-3" id="botonesReporte">
            ...
            <button class="btn bg-primary" id='btn_search_ListaS07' type="button"><span class="glyphicon glyphicon-filter">&nbsp;Filtrar</span></button>
            <button class="btn btn-default active" id='btn_excel_CuadranteS07' data-flag="2" type="button"><span class="glyphicon glyphicon-download">&nbsp;Excel</span></button>
