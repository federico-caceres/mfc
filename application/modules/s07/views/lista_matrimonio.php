...
<table id="tablero_s07" class="table table-striped">
    <thead>
        <tr>
        ...
        if (isset($matrimonios) && sizeof($matrimonios) > 0) {
            foreach ($matrimonios as $key => $value) {
                ...
                <tr id='fila_<?= $value->idmatrimonio ?>'>
                    ...
                    <td class="descarto"><?= strtoupper($value->estado) ?></td>
                    ...
                    <td id="botonesAccion">     
                        ...
                        <button title="Reactivar Matrimonio" id="reactivarMatrimonio" data-idmatrimonio="<?= $value->idmatrimonio ?>" class="btn btn-default <?= $muestraS07 ?>" >
                            <span>
