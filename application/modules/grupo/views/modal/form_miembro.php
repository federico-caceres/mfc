...
$matrimonios;
?>
<div id="contieneFormMiembro" class="col-sm-12 well" style="background-color:  #D8D8D8">

    <form id="formMiembro" name="formMiembro">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2"><strong>Matrimonio</strong></div>
            <div class="col-sm-3">
                <?php echo Modules::run('componente/select', array('idSelect' => 'idmatrimonio', "clase" => "chosenselect", 'view_flag' => 30, 'data_select' => $matrimonios, 'nameSelect' => 'idmatrimonio', 'msgSelect' => 'Elije..')); //'selected' => (intval($edit) > 0 && isset($miembro[0]->idmatrimonio)) ? $miembro[0]->idmatrimonio : '-1', ?>
            </div>
        </div>

    </form>
    <div class="col-sm-12">
        <button id="guardarMiembro" class="btn btn-primary" onclick="guardaMiembro();">Guardar Miembro</button>
        <button id="cancelarMiembro" data-idgrupo="<?= $grupo[0]->idgrupo ?>" class="btn btn-danger">Cancelar</button>
    </div>
</div>