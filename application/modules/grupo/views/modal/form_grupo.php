...
?>
<div id="contieneFormGrupo" class="col-sm-12 well" style="background-color:  #D8D8D8">
    ...
    <form id="formGrupo" name="formGrupo">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3"><input name="grupo" type="text" class="form-control" id="grupo" value="<?= (intval($edit) > 0 && (isset($grupo[0]->nombreGrupo))) ? $grupo[0]->nombreGrupo : ''; ?>" required <?= $lectura ?>></div>
        </div> 
        <div class="form-group row">
    ...
    <div class="col-sm-12">
        <button id="guardarGrupo" class="btn btn-primary <?= $muestra ?>" >Guardar Equipo</button>
        <button id="cancelarGrupo" class="btn btn-danger">Cancelar</button>
    </div>
</div>