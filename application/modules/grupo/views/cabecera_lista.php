...
<!--        <div class="col-sm-1"><strong>Desde:</strong></div>
        ...
        <div class="col-sm-3" id="botonesReporte">
            ...
            <button class="btn bg-primary" id='btn_search_ListaEquipos' type="button"><span class="glyphicon glyphicon-filter">&nbsp;Filtrar</span></button>
<!--            <button class="btn btn-default active" id='btn_excel_Equipos' data-flag="2" type="button"><span class="glyphicon glyphicon-download">&nbsp;Excel</span></button>-->
